...
import { FaXTwitter, FaFacebook, FaInstagram, FaGithubAlt } from "react-icons/fa6";
import { GiTBrick, GiThunderBlade } from "react-icons/gi";
...
export const SOCIAL_MEDIA_LINKS = [
  {
    ...
    icon: <FaGithubAlt fontSize={30} className="hover:opacity-80" />,
  },

  {
    href: "https://www.linkedin.com/in/pratik-raj-375034217/",
    icon: <CiLinkedin fontSize={30} className="hover:opacity-80" />,
  },
  {
    href: "https://x.com/pratik_solderet",
